...
export const Volunteer: React.FC = () => {
  ...
  return (
    <div className="flex flex-col w-full bg-[#F8F9FA]">
      ...
      {/* Onboarding Steps Timeline (Solves Audit finding #19) */}
      <section className="w-full py-12 bg-white border-b border-[#E1E3E4]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-8">
            <span className="text-xs font-bold uppercase tracking-wider text-[#006E25]">WHAT HAPPENS AFTER YOU APPLY</span>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-[#001E40] mt-1">Our Transparent Onboarding Steps</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-left">
            <div className="p-5 bg-[#F8F9FA] rounded-2xl border border-[#E1E3E4] flex flex-col gap-2">
              <span className="w-8 h-8 rounded-full bg-[#003366] text-white font-bold flex items-center justify-center text-xs">1</span>
              <h3 className="text-sm font-bold text-[#001E40]">Application Submission</h3>
              <p className="text-xs text-[#43474F]">Submit your role interest & location via our verified on-site form below.</p>
            </div>

            <div className="p-5 bg-[#F8F9FA] rounded-2xl border border-[#E1E3E4] flex flex-col gap-2">
              <span className="w-8 h-8 rounded-full bg-[#003366] text-white font-bold flex items-center justify-center text-xs">2</span>
              <h3 className="text-sm font-bold text-[#001E40]">Coordinator Contact</h3>
              <p className="text-xs text-[#43474F]">Our volunteer head contacts you within 48 hours for a brief orientation call.</p>
            </div>

            <div className="p-5 bg-[#F8F9FA] rounded-2xl border border-[#E1E3E4] flex flex-col gap-2">
              <span className="w-8 h-8 rounded-full bg-[#003366] text-white font-bold flex items-center justify-center text-xs">3</span>
              <h3 className="text-sm font-bold text-[#001E40]">Chapter Assignment</h3>
              <p className="text-xs text-[#43474F]">Join your city WhatsApp chapter & get assigned to your chosen flagship project.</p>
            </div>

            <div className="p-5 bg-[#F8F9FA] rounded-2xl border border-[#E1E3E4] flex flex-col gap-2">
              <span className="w-8 h-8 rounded-full bg-[#006E25] text-white font-bold flex items-center justify-center text-xs">4</span>
              <h3 className="text-sm font-bold text-[#001E40]">Ground Impact & Certificate</h3>
              <p className="text-xs text-[#43474F]">Execute ground drives & receive official Section 8 internship/volunteer certificates.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-16">
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-white rounded-3xl border border-[#E1E3E4] shadow-lg p-6 sm:p-10 text-left">
            <div className="flex items-center gap-3 pb-6 border-b border-[#E1E3E4] mb-8">
              <div className="w-12 h-12 rounded-xl bg-[#003366]/10 flex items-center justify-center text-[#003366]">
                <Users className="w-6 h-6" />
              </div>
              <div>
                <h2 className="text-2xl font-extrabold text-[#001E40]">Volunteer Intake Application</h2>
                <p className="text-xs text-[#737780] mt-0.5">Please fill out your details to join the InAmigos Foundation volunteer network.</p>
              </div>
            </div>

            {isSubmitted ? (
              <div className="py-12 px-6 text-center bg-emerald-50 rounded-2xl border border-emerald-200 flex flex-col items-center gap-4">
                <div className="w-16 h-16 rounded-full bg-[#006E25] text-white flex items-center justify-center shadow-lg">
                  <CheckCircle2 className="w-10 h-10" />
                </div>
                <h3 className="text-2xl font-extrabold text-[#001E40]">Application Received!</h3>
                ...
                <div className="p-3 bg-white rounded-xl border border-emerald-300 text-xs text-[#006E25] font-semibold">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6" noValidate>
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-sm font-semibold text-[#191C1D]">
                    Preferred Field of Action <span className="text-[#BA1A1A]">*</span>
                  </label>
                  <select
                ...
                <div className="pt-4 border-t border-[#E1E3E4] flex items-center justify-between gap-4">
                  <span className="text-xs text-[#737780] flex items-center gap-1">
                    <ShieldCheck className="w-4 h-4 text-[#006E25]" /> Verified On-Site Form
                  </span>
