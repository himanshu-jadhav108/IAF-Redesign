  ...
  return (
    <PageTransition>
      <div className="flex flex-col w-full bg-[#F8F9FA] dark:bg-slate-900 transition-colors">
        ...
        {/* Onboarding Steps Timeline with Staggered Reveal */}
        <section className="w-full py-12 bg-white dark:bg-slate-900 border-b border-[#E1E3E4] dark:border-slate-800 transition-colors">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <ScrollReveal className="text-center max-w-2xl mx-auto mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-left">
              <ScrollReveal delay={0.05} className="p-5 bg-[#F8F9FA] dark:bg-slate-800 border border-[#E1E3E4] dark:border-slate-700 rounded-2xl flex flex-col gap-2">
              ...
              <ScrollReveal delay={0.1} className="p-5 bg-[#F8F9FA] dark:bg-slate-800 border border-[#E1E3E4] dark:border-slate-700 rounded-2xl flex flex-col gap-2">
              ...
              <ScrollReveal delay={0.15} className="p-5 bg-[#F8F9FA] dark:bg-slate-800 border border-[#E1E3E4] dark:border-slate-700 rounded-2xl flex flex-col gap-2">
              ...
              <ScrollReveal delay={0.2} className="p-5 bg-[#F8F9FA] dark:bg-slate-800 border border-[#E1E3E4] dark:border-slate-700 rounded-2xl flex flex-col gap-2">
        ...
        <section className="w-full py-16">
          <div className="max-w-4xl mx-auto px-4">
            <ScrollReveal className="bg-white dark:bg-slate-800 rounded-3xl border border-[#E1E3E4] dark:border-slate-700 shadow-lg p-6 sm:p-10 text-left">
              ...
              {isSubmitted ? (
                <div className="py-12 px-6 text-center bg-emerald-50 dark:bg-emerald-950/40 rounded-2xl border border-emerald-200 dark:border-emerald-800 flex flex-col items-center gap-4 animate-in fade-in duration-300">
