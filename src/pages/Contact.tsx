      ...
      <div className="flex flex-col w-full bg-[#F8F9FA] dark:bg-slate-900 transition-colors">
        ...
        <section className="w-full py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <ScrollReveal className="lg:col-span-5 flex flex-col gap-6 text-left">
            ...
            <ScrollReveal direction="left" className="lg:col-span-7 bg-white dark:bg-slate-800 rounded-3xl border border-[#E1E3E4] dark:border-slate-700 shadow-lg p-6 sm:p-10 text-left">
