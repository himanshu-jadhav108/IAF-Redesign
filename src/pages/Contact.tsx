      ...
      <section className="w-full py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 text-left">
            <div className="bg-white p-8 rounded-3xl border border-[#E1E3E4] shadow-sm flex flex-col gap-6">
              <h2 className="text-xl font-extrabold text-[#001E40]">Official Registered Office</h2>

              <div className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-xl bg-[#003366]/10 flex items-center justify-center text-[#003366] shrink-0 mt-0.5">
                  <MapPin className="w-5 h-5" />
                </div>
                <div>
                  <span className="text-xs font-bold text-[#006E25] uppercase tracking-wider">Address</span>
                  <p className="text-sm font-semibold text-[#191C1D] mt-0.5">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <span className="text-xs font-bold text-[#006E25] uppercase tracking-wider">Official Phone</span>
                  <p className="text-sm font-semibold text-[#191C1D] mt-0.5">
                    <a href={`tel:${organizationData.contact.phone}`} className="hover:text-[#003366]">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <span className="text-xs font-bold text-[#006E25] uppercase tracking-wider">Official Email</span>
                  <p className="text-sm font-semibold text-[#191C1D] mt-0.5">
                    <a href={`mailto:${organizationData.contact.email}`} className="hover:text-[#003366]">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <span className="text-xs font-bold text-[#006E25] uppercase tracking-wider">Registration Details</span>
            ...
            <div className="bg-[#001E40] text-white p-6 rounded-3xl border border-[#003366]">
          ...
          <div className="lg:col-span-7 bg-white rounded-3xl border border-[#E1E3E4] shadow-lg p-6 sm:p-10 text-left">
            <h2 className="text-xl font-extrabold text-[#001E40] mb-6">Send Us A Direct Message</h2>

            {isSubmitted ? (
              <div className="py-10 px-6 text-center bg-emerald-50 rounded-2xl border border-emerald-200 flex flex-col items-center gap-3">
                <CheckCircle2 className="w-12 h-12 text-[#006E25]" />
                <h3 className="text-xl font-bold text-[#001E40]">Message Prepared!</h3>
                <p className="text-xs text-[#43474F] max-w-md">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6" noValidate>
                ...
                <div className="pt-2 flex items-center justify-between gap-4 border-t border-[#E1E3E4]">
                  <span className="text-xs text-[#737780] flex items-center gap-1">
                    <ShieldCheck className="w-4 h-4 text-[#006E25]" /> Persistent Labels & Validated Form
                  </span>
